...
/**
 * Base class for a layer, responsible for camera and input management.
 * This is analogous to the AbstractLayer.java class.
 */
export class AbstractLayer {
    /**
     * Creates a new AbstractLayer.
     */
    constructor() {
    ...
    /**
     * Handles pointer down events. This method should be overridden by subclasses.
    ...
    /**
     * Handles pointer up events. This method should be overridden by subclasses.
     * @param {PointerEvent} event - The pointer event.
     */
    onPointerUp(event) {
        event.preventDefault();
    ...
    /**
     * Handles pointer move events. This method should be overridden by subclasses.
     * @param {PointerEvent} event - The pointer event.
     */
    onPointerMove(event) {
        event.preventDefault();
